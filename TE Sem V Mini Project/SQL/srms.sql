...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2024 at 09:59 AM
...
INSERT INTO `students` (`id`, `ien_number`, `first_name`, `last_name`, `date_of_birth`, `gender`, `email`, `address`, `student_number`, `year`, `season`, `department`, `batch`, `semester`) VALUES
(1, 12222007, 'Varun', 'Joshi', '2004-10-31', 'Male', 'varunjoshi311004@gmail.com', 'D-306 Shree Chamunda Garden 90 Ft Rd ,Thakurli (E.)', '7715881457', 2024, 'Summer', 'COMPS', 'TE', 'Sem 5'),
(2, 12222004, 'Jay', 'Makwana', '2004-06-22', 'Male', 'varunjoshi311004@gmail.com', 'as,dhahsbakjshkasasd', '9831654755', 2024, 'Winter', 'COMPS', 'SE', 'Sem 3'),
(3, 12222005, 'Vedant', 'Navthale', '2004-11-15', 'Male', 'vedantnavthale222@nhitm.ac.in', 'asdkabsifbkjas.,dkoashd', '9565687546', 2024, 'Summer', 'COMPS', 'TE', 'Sem 5'),
(10, 12222006, 'Rohit', 'Joshi', '2005-07-13', 'Male', 'rohitjoshi222@nhitm.ac.in', 'asdlkjasn.,ms.nd', '9546853541', 2025, 'Winter', 'AIDS', 'TE', 'Sem 5');
...
INSERT INTO `subjects` (`id`, `Subject`, `Batch`, `Semester`, `Department`) VALUES
(1, 'Software Engineering', 'TE', 'Sem 5', 'COMPS'),
(2, 'Theoretical Computer Science', 'TE', 'Sem 5', 'COMPS'),
(3, 'Software Engineering Lab', 'TE', 'Sem 5', 'COMPS'),
...
(44, 'Mini Project :2B', 'TE', 'Sem 6', 'COMPS');
