...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == "add") {
        if ($result->num_rows > 0) {
            ...
            $insertQuery = "INSERT INTO students (ien_number, first_name, last_name, date_of_birth, gender, email, address, student_number, year, season, department, batch, semester)
                            VALUES ('$student_ien_no', '$first_name', '$last_name', '$dob', '$gender', '$email', '$address', '$phone', '$year', '$season', '$department', '$batch', '$semester')";
